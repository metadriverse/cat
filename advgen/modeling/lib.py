...
class GlobalGraph(nn.Module):
    ...
    def __init__(self, hidden_size, attention_head_size=None, num_attention_heads=1):
        ...
        if advgen.utils.args.attention_decay:
    ...
    def forward(self, hidden_states, attention_mask=None, mapping=None, return_scores=False):
        ...
        if advgen.utils.args.attention_decay and advgen.utils.second_span:
            advgen.utils.logging(self.attention_decay, prob=0.01)
...
class SubGraph(nn.Module):
    ...
    def forward(self, hidden_states: torch.Tensor, li_vector_num=None):
        ...
        advgen.utils.logging('subgraph', sub_graph_batch_size, max_vector_num, hidden_size, prob=0.001)
